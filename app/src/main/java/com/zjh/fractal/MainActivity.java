...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        if (flag_should_change_data) {
            ...
            GenerateFractal((int) (screenHeight * pixel_times), (int) (screenWidth * pixel_times), center_x, center_y,
                    ...
                    iteration_times, use_thread, get_iteration_auto_max(), 0);
            update_info();
    ...
    public native void GenerateFractal(int screen_height, int screen_width, double center_x, double center_y,
            double scale_times, int fractal_id, int color_reversal, int generate_mode, int iteration_times,
            int use_thread, int auto_iteration_max, int monitor_generate_info);
