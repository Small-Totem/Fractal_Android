...
public class Definition {
    ...
    public static double center_re            = 0;
    public static double center_im            = 0;
    public static double scale_times          = 0.5;
    public static double pixel_times          = 0.5;//渲染倍率
    public static double generate_now_quality = 0.3;//立即渲染倍率
    ...
    public static int use_thread         = 8;       // 使用的线程数 ( 可能的取值:1,2,4,6,8,10 )
    public static int auto_iteration_max = 2000;
    //public static int auto_iteration_grow_times = 5;//自适应迭代的增长倍数
    public static int paint_mode         = 1;       // 0=svpng,1=canvas,2=canvas/不修正
